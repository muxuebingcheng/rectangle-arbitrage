...
def main():
    ...
    for path in path_info:
        x_and_a = calc_core.calc_x_and_a(path)
        x_profit= calc_core.calc_profit(x_and_a)
        if(x_profit > 1):
            x_and_a_list.append(x_and_a)
    data_send = data_process.format_send_data(x_and_a_list)
