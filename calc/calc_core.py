...
def calc_profit(r, currency_a,currency_b, path_list,platform,logger):
    ...
    for path in path_list:
        ...
        a_num_list = [a1_done, a1_done, a4_done, a4_done]
...
# def recalc_profit(r, currency_a,currency_b, path_list,step):
#     #currency_name = mtn
#     #os.pid
#     pid =str(os.getpid())
#     if currency_a == currency_b:
...
#     #{"from": "iost", "to": "eth", "type": "buy", "market": "false", "amount": "1", "price": "1"}
#
#     path1 = {'from':'eth','to':currency_a,'type':'buy','market':'false','amount':a_num_list[0],'price':a_price_record[0]}
#
#     path2 = {'from': currency_a, 'to': 'btc', 'type': 'sell', 'market': 'false', 'amount': a_num_list[1],'price': a_price_record[1]}
#
#     path3 = {'from': 'btc', 'to': currency_b, 'type': 'buy', 'market': 'false', 'amount': a_num_list[2],'price': a_price_record[2]}
#
...
# def recalc(redis_info):
#     r = redis.Redis(host=redis_info[0],
#                     port=redis_info[1])
#     while True:
#         recalc_info = r.lpop('list_recalc')
